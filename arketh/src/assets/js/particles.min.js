...
var pJS = function (e, a) {
  ...
  a && Object.deepExtend(i, a), i.tmp.obj = {
    ...
    if (e.color.rgb) var n = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + t + ")"; else n = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + t + ")";
    ...
    var t = e.x - a.x, n = e.y - a.y, s = Math.sqrt(t * t + n * n);
    ...
    if (Math.sqrt(t * t + n * n) <= i.particles.line_linked.distance) {
      var s = t / (1e3 * i.particles.move.attract.rotateX), r = n / (1e3 * i.particles.move.attract.rotateY);
    ...
    if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
      ...
      if (i.tmp.bubble_clicking) {
        ...
        var l = Math.sqrt(a * a + t * t), v = ((new Date).getTime() - i.interactivity.mouse.click_time) / 1e3;
      ...
      function p(a, t, n, s, r) {
        if (a != t) if (i.tmp.bubble_duration_end) null != n && (o = a + (a - (s - v * (s - a) / i.interactivity.modes.bubble.duration)), "size" == r && (e.radius_bubble = o), "opacity" == r && (e.opacity_bubble = o)); else if (l <= i.interactivity.modes.bubble.distance) {
    ...
    if (i.interactivity.events.onhover.enable && isInArray("repulse", i.interactivity.events.onhover.mode) && "mousemove" == i.interactivity.status) {
      var a = e.x - i.interactivity.mouse.pos_x, t = e.y - i.interactivity.mouse.pos_y, n = Math.sqrt(a * a + t * t),
        s = a / n, r = t / n,
      ...
      var l = Math.pow(i.interactivity.modes.repulse.distance / 6, 3), v = i.interactivity.mouse.click_pos_x - e.x,
        p = i.interactivity.mouse.click_pos_y - e.y, d = v * v + p * p, m = -l / d * 1;
      d <= l && function () {
        var a = Math.atan2(p, v);
        if (e.vx = m * Math.cos(a), e.vy = m * Math.sin(a), "bounce" == i.particles.move.out_mode) {
          var t = e.x + e.vx, n = e.y + e.vy;
    ...
    for (var t = 0; t < i.particles.array.length; t++) {
      var n = i.particles.array[t], s = e.x - n.x, r = e.y - n.y;
    ...
    var a = i.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function (a, t, i, n) {
        ...
        return s
      }), t = new Blob([a], {type: "image/svg+xml;charset=utf-8"}), n = window.URL || window.webkitURL || window,
      s = n.createObjectURL(t), r = new Image;
...
Object.deepExtend = function (e, a) {
  ...
  var t = document.getElementById(e), i = "particles-js-canvas-el", n = t.getElementsByClassName(i);
  ...
  particles: {
    ...
    opacity: {value: .5, random: !1, anim: {enable: !1, speed: 1, opacity_min: .9, sync: !1}},
